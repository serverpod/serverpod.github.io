...
https://docs.serverpod.dev/2.7.0/concepts/database/migrations
...
See the [Pre-migration project upgrade path](https://docs.serverpod.dev/2.7.0/upgrading/upgrade-to-one-point-two.md) section for more information on how to get started with migrations for any project created before migrations were introduced in Serverpod.
