...
It is now possible to make any other relation to our model as described in [one-to-one](https://docs.serverpod.dev/2.7.0/concepts/database/relations/one-to-one.md), [one-to-many](https://docs.serverpod.dev/2.7.0/concepts/database/relations/one-to-many.md), [many-to-many](https://docs.serverpod.dev/2.7.0/concepts/database/relations/many-to-many.md) and [self-relations](https://docs.serverpod.dev/2.7.0/concepts/database/relations/self-relations.md).
