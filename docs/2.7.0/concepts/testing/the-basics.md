...
https://docs.serverpod.dev/2.7.0/concepts/testing/the-basics
...
To build out a `Session` (to use for [database calls](#seeding-the-database) or [pass on to functions](https://docs.serverpod.dev/2.7.0/concepts/testing/advanced-examples.md#test-business-logic-that-depends-on-session)), simply call the `build` method:
...
See also [this complete example](https://docs.serverpod.dev/2.7.0/concepts/testing/advanced-examples.md#multiple-users-interacting-with-a-shared-stream).
