...
https://docs.serverpod.dev/2.7.0/concepts/logging
...
You can use the companion app  **[Serverpod Insights](https://docs.serverpod.dev/2.7.0/tools/insights.md)** to read, search, and configure the logs.
