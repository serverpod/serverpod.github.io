...
The package also provides general-purpose utilities to facilitate building IDPs. See [OAuth2 Utility](https://docs.serverpod.dev/concepts/authentication/providers/custom-providers/oauth2-utility/setup.md).
:::
