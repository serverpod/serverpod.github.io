...
For more details on configuration options, see the [configuration section](https://docs.serverpod.dev/concepts/authentication/providers/github/configuration.md).
...
For details on how to customize the GitHub Sign-In UI in your Flutter app, see the [customizing the UI section](https://docs.serverpod.dev/concepts/authentication/providers/github/customizing-the-ui.md).
