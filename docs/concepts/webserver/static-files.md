...
https://docs.serverpod.dev/concepts/webserver/static-files
...
For dynamic content that changes per request, see [Server-side HTML](https://docs.serverpod.dev/concepts/webserver/server-side-html.md).
