...
https://docs.serverpod.dev/concepts/webserver/single-page-apps
...
For serving Flutter web applications specifically, see [Flutter web apps](https://docs.serverpod.dev/concepts/webserver/flutter-web.md).
