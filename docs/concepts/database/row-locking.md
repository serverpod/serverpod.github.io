...
https://docs.serverpod.dev/concepts/database/row-locking
...
:::warning
All row locking operations require a [transaction](https://docs.serverpod.dev/concepts/database/transactions.md). An exception will be thrown if you attempt to acquire a lock without one.
:::
