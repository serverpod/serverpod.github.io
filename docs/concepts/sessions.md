...
- **`db`** - Database access. [See database docs](https://docs.serverpod.dev/concepts/database/connection.md)
- **`caches`** - Local and distributed caching. [See caching docs](https://docs.serverpod.dev/concepts/caching.md)
- **`storage`** - File storage operations. [See file uploads](https://docs.serverpod.dev/concepts/file-uploads.md)
- **`messages`** - Server events for real-time communication within and across servers. [See server events docs](https://docs.serverpod.dev/concepts/server-events.md)
- **`passwords`** - Credentials from config and environment. [See configuration](https://docs.serverpod.dev/concepts/configuration.md)
- **`authenticated`** - Current user authentication info. [See authentication docs](https://docs.serverpod.dev/concepts/authentication/basics.md)
...
For detailed testing strategies, see the [testing documentation](https://docs.serverpod.dev/concepts/testing/get-started.md).
