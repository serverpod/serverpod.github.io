...
https://docs.serverpod.dev/concepts/configuration
...
See the [testing documentation](https://docs.serverpod.dev/concepts/testing/get-started.md) for more details.
...
This allows you to reference module classes as `module:auth:AuthUser` in your model files. See the [modules documentation](https://docs.serverpod.dev/concepts/modules.md) for more information.
...
Models and the protocol file are generated in each shared package's own directory when you run `serverpod generate` from your server project. See the [shared packages documentation](https://docs.serverpod.dev/concepts/shared-packages.md) for setup, usage, and restrictions.
...
See the [serialization documentation](https://docs.serverpod.dev/concepts/serialization.md) for implementing custom serializable classes.
...
See the [experimental features documentation](https://docs.serverpod.dev/concepts/experimental.md) for detailed information about each feature.
