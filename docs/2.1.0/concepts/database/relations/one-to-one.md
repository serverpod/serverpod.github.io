...
https://docs.serverpod.dev/2.1.0/concepts/database/relations/one-to-one
...
An object relation field gives a big advantage when fetching data. Utilizing [relational queries](https://docs.serverpod.dev/2.1.0/concepts/database/relation-queries.md) enables filtering based on relation attributes or optionally including the related data in the result.
