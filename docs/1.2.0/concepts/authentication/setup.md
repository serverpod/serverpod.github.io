...
https://docs.serverpod.dev/1.2.0/concepts/authentication/setup
...
The full migration instructions can be found in the [migration guide](https://docs.serverpod.dev/1.2.0/concepts/database/migrations.md).
