...
https://docs.serverpod.dev/1.2.0/concepts/authentication/providers/google
...
:::caution
You need to install the auth module before you continue, see [Setup](https://docs.serverpod.dev/1.2.0/concepts/authentication/setup.md).
:::
