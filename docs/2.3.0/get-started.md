...
https://docs.serverpod.dev/2.3.0/get-started
...
**[Get started with Mini](https://docs.serverpod.dev/2.3.0/get-started-with-mini.md)**
...
To learn more about endpoints, see the [Working with endpoints](https://docs.serverpod.dev/2.3.0/concepts/working-with-endpoints.md) section.
...
You can also create custom serialized classes with tools such as Freezed. Learn more in the [Serialization](https://docs.serverpod.dev/2.3.0/concepts/serialization.md) section.
...
To learn more about database migrations, see the [Migrations](https://docs.serverpod.dev/2.3.0/concepts/database/migrations.md) section.
...
To learn more about database CRUD operations, see the [CRUD](https://docs.serverpod.dev/2.3.0/concepts/database/crud.md) section.
