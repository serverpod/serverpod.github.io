...
https://docs.serverpod.dev/1.0.0/capabilities
...
Serverpod comes with Terraform scripts for AWS, which makes it very quick to deploy your server. We are still working on scripts for Google Cloud and other platforms. Please get in touch with us if you want to [contribute](https://docs.serverpod.dev/contribute.md).
