...
https://docs.serverpod.dev/2.9.0/concepts/authentication/providers/google
...
:::caution
You need to install the auth module before you continue, see [Setup](https://docs.serverpod.dev/2.9.0/concepts/authentication/setup.md).
:::
