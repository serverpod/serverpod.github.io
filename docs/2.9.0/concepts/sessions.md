...
https://docs.serverpod.dev/2.9.0/concepts/sessions
...
A Serverpod Session should not be confused with the concept of "web sessions" or "user sessions" which persist over multiple API calls. See the [Authentication documentation](https://docs.serverpod.dev/2.9.0/concepts/authentication/setup.md) for managing persistent authentication.
...
- **`db`** - Database access. [See database docs](https://docs.serverpod.dev/2.9.0/concepts/database/connection.md)
- **`caches`** - Local and distributed caching. [See caching docs](https://docs.serverpod.dev/2.9.0/concepts/caching.md)
- **`storage`** - File storage operations. [See file uploads](https://docs.serverpod.dev/2.9.0/concepts/file-uploads.md)
- **`messages`** - Server events for real-time communication within and across servers. [See server events docs](https://docs.serverpod.dev/2.9.0/concepts/server-events.md)
- **`passwords`** - Credentials from config and environment. [See configuration](https://docs.serverpod.dev/2.9.0/concepts/configuration.md)
- **`authenticated`** - Current user authentication info. [See authentication docs](https://docs.serverpod.dev/2.9.0/concepts/authentication/basics.md)
...
For detailed testing strategies, see the [testing documentation](https://docs.serverpod.dev/2.9.0/concepts/testing/get-started.md).
