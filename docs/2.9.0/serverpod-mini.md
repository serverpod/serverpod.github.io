...
https://docs.serverpod.dev/2.9.0/serverpod-mini
...
You are now ready to start exploring the exciting world of Serverpod! And even if you start out with Serverpod mini, you can always [upgrade](https://docs.serverpod.dev/2.9.0/upgrading/upgrade-from-mini.md) to the full version later.
