...
https://docs.serverpod.dev/2.9.0/upgrading/upgrade-to-pgvector
...
For more details on creating and applying migrations, see the [Migrations](https://docs.serverpod.dev/2.9.0/concepts/database/migrations.md) section.
