...
https://docs.serverpod.dev/2.9.0/get-started/working-with-the-database
...
:::info
Check out the reference for [database models](https://docs.serverpod.dev/2.9.0/concepts/models.md#keywords-1) for an overview of all available keywords.
:::
...
The `insertRow` method is used to insert a new row in the database. The `find` method is used to query the database and get all the rows of a specific type. See [CRUD](https://docs.serverpod.dev/2.9.0/concepts/database/crud.md) and [relation queries](https://docs.serverpod.dev/2.9.0/concepts/database/relation-queries.md) for more information.
:::
...
:::tip
Database operations are a broad topic, and Serverpod's ORM offers many powerful features. To learn more about advanced database operations, check out the [Database](https://docs.serverpod.dev/2.9.0/concepts/database/connection.md) section.
:::
