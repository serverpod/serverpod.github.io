...
This operation returns the first model matching the filtering criteria or `null`. See [filter](https://docs.serverpod.dev/2.0.0/concepts/database/filter.md) and [sort](https://docs.serverpod.dev/2.0.0/concepts/database/sort.md) for all filter operations.
...
See [filter](https://docs.serverpod.dev/2.0.0/concepts/database/filter.md) and [sort](https://docs.serverpod.dev/2.0.0/concepts/database/sort.md) for all filter and sorting operations and [pagination](https://docs.serverpod.dev/2.0.0/concepts/database/pagination.md) for how to paginate the result.
...
You can also do a [filtered](https://docs.serverpod.dev/2.0.0/concepts/database/filter.md) delete and delete all entries matching a `where` query, by using the `deleteWhere` method.
...
Count is a special type of query that helps counting the number of rows in the database that matches a specific [filter](https://docs.serverpod.dev/2.0.0/concepts/database/filter.md).
