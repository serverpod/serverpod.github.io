...
https://docs.serverpod.dev/1.1.1/concepts/authentication/providers/google
...
:::caution
You need to install the auth module before you continue, see [Setup](https://docs.serverpod.dev/1.1.1/concepts/authentication/setup.md).
:::
