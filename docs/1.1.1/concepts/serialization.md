...
https://docs.serverpod.dev/1.1.1/concepts/serialization
...
Serverpod's serializable objects can easily be saved to or read from the database. You can read more about this in the next section, [Database communication](https://docs.serverpod.dev/1.1.1/concepts/database-communication.md).
