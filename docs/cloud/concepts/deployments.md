...
https://docs.serverpod.dev/cloud/concepts/deployments
...
:::info
If this is the first time you're deploying this project to Cloud, follow [Deploy your first app](https://docs.serverpod.dev/cloud/getting-started/launch.md) first. It walks through `serverpod cloud launch`, which creates the project before the first deploy.
:::
...
To use your own URL instead, see [Custom domains](https://docs.serverpod.dev/cloud/concepts/custom-domains.md).
...
To regenerate code or run other tasks before each deploy, configure a pre-deploy hook. See [Deployment hooks](https://docs.serverpod.dev/cloud/concepts/deployment-hooks.md).
...
For a step-by-step walkthrough, see [Recover from a failed deploy](https://docs.serverpod.dev/cloud/guides/recover-from-a-failed-deploy.md).

## Related

- [Deployment hooks](https://docs.serverpod.dev/cloud/concepts/deployment-hooks.md) for pre- and post-deploy automation.
- [Private dependencies](https://docs.serverpod.dev/cloud/reference/private-dependencies.md) for private package access during the build.
- [Ship non-Dart files with your server](https://docs.serverpod.dev/cloud/guides/ship-non-dart-files.md) for shipping static assets like configuration and templates.
- [Deploy from CI with GitHub Actions](https://docs.serverpod.dev/cloud/guides/deploy-from-ci-with-github-actions.md) for shipping every push.
