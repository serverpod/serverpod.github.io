...
https://docs.serverpod.dev/cloud/concepts/cdn
...
- **Every hostname covered:** The CDN serves any [custom domains](https://docs.serverpod.dev/cloud/concepts/custom-domains.md) attached to your project, and the deploy purge clears them too.

## Related

- [Deployments](https://docs.serverpod.dev/cloud/concepts/deployments.md): the deploy that clears the cache.
- [Custom domains](https://docs.serverpod.dev/cloud/concepts/custom-domains.md): the CDN covers your custom domains too.
- [Static files](https://docs.serverpod.dev/concepts/webserver/static-files.md): the framework reference for `cacheControlFactory` and cache busting.
- [Single-page apps](https://docs.serverpod.dev/concepts/webserver/single-page-apps.md): serving another framework's single-page app with `SpaRoute`.
- [Flutter web apps](https://docs.serverpod.dev/concepts/webserver/flutter-web.md): serving a Flutter build from the framework web server.
