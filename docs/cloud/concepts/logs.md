...
https://docs.serverpod.dev/cloud/concepts/logs
...
For a step-by-step walkthrough of diagnosing and recovering from a failed deploy, see [Recover from a failed deploy](https://docs.serverpod.dev/cloud/guides/recover-from-a-failed-deploy.md).
...
See [Passwords, secrets, and environment variables](https://docs.serverpod.dev/cloud/concepts/passwords-secrets-env-vars.md) for variable management.
...
Adjust the values to fit your project. See [Purge old records](https://docs.serverpod.dev/concepts/operations/logging.md#purge-old-records) for what each setting does.

For what the server records, which tables it writes to, and how retention works, see [Logging](https://docs.serverpod.dev/concepts/operations/logging.md) in the framework documentation.
...
- [CLI reference: `log` command](https://docs.serverpod.dev/cloud/reference/cli/commands/log.md)
- [CLI reference: `build` command](https://docs.serverpod.dev/cloud/reference/cli/commands/build.md)
- [CLI reference: `status` command](https://docs.serverpod.dev/cloud/reference/cli/commands/status.md)
