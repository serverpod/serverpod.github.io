...
https://docs.serverpod.dev/cloud/getting-started/launch
...
- The Serverpod Cloud CLI set up and authenticated. See [Set up the Cloud CLI](https://docs.serverpod.dev/cloud/getting-started/installation.md).
- A Serverpod project on your machine. See [Creating a new project](https://docs.serverpod.dev/quickstart.md#create-the-project) in the Serverpod installation guide.
...
3. **Pre-deploy hooks.** The command adds `serverpod generate` as a pre-deploy hook, plus `serverpod run flutter_build` if your server's `pubspec.yaml` defines that script. See [Deployment hooks](https://docs.serverpod.dev/cloud/concepts/deployment-hooks.md) for details.
...
- Every change you make ships with `serverpod cloud deploy`. See [Deployments](https://docs.serverpod.dev/cloud/concepts/deployments.md) for the full deploy lifecycle.
- To use your own domain instead of `<project>.serverpod.space`, see [Custom domains](https://docs.serverpod.dev/cloud/concepts/custom-domains.md).
