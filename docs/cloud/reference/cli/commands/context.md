...
https://docs.serverpod.dev/cloud/reference/cli/commands/context
...
For a per-repository default, link the directory instead with [`scloud project link`](https://docs.serverpod.dev/cloud/reference/cli/commands/project.md).
