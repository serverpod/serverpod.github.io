...
https://docs.serverpod.dev/cloud/reference/cli/commands/password
...
For the model (when to use passwords vs secrets vs variables, platform-managed defaults, and naming rules), see [Passwords, secrets, and environment variables](https://docs.serverpod.dev/cloud/concepts/passwords-secrets-env-vars.md).
