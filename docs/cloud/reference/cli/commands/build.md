...
https://docs.serverpod.dev/cloud/reference/cli/commands/build
...
Build secrets cover credentials the build needs and your source code shouldn't carry. See [Private dependencies](https://docs.serverpod.dev/cloud/reference/private-dependencies.md) for the setup that uses them, and [Passwords, secrets, and environment variables](https://docs.serverpod.dev/cloud/concepts/passwords-secrets-env-vars.md) for the values your server reads at runtime.

For where the build sits in the deploy lifecycle, see [Deployments](https://docs.serverpod.dev/cloud/concepts/deployments.md). To work through a failed build step by step, see [Recover from a failed deploy](https://docs.serverpod.dev/cloud/guides/recover-from-a-failed-deploy.md).
