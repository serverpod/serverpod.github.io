...
https://docs.serverpod.dev/cloud/reference/cli/commands/log
...
See [Logs](https://docs.serverpod.dev/cloud/concepts/logs.md) for the time-format options (duration strings, ISO 8601), how `--tail` interacts with `--since` / `--until`, and session-log configuration.
