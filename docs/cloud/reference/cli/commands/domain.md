...
https://docs.serverpod.dev/cloud/reference/cli/commands/domain
...
See [Custom domains](https://docs.serverpod.dev/cloud/concepts/custom-domains.md) for the attach flow, DNS record types for apex vs subdomain, propagation timing, and TLS details.
