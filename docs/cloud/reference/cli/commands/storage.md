...
https://docs.serverpod.dev/cloud/reference/cli/commands/storage
...
For how your server connects to these storages, see [File uploads](https://docs.serverpod.dev/concepts/endpoints-and-apis/file-uploads.md#configure-a-storage-provider) in the framework documentation.
