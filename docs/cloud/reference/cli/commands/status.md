...
To follow a deploy attempt in detail, use [`scloud status deployment`](https://docs.serverpod.dev/cloud/reference/cli/commands/status.md); to read runtime output, use [`scloud log`](https://docs.serverpod.dev/cloud/reference/cli/commands/log.md).
