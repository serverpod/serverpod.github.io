...
https://docs.serverpod.dev/2.4.0/get-started
...
**[Get started with Mini](https://docs.serverpod.dev/2.4.0/get-started-with-mini.md)**
...
The full version of Serverpod needs access to a Postgres database. The easiest way to set that up is to use our pre-configured Docker container. Install **[Flutter](https://flutter.dev/docs/get-started/install)**, **[Serverpod](https://docs.serverpod.dev/index.md)** and **[Docker Desktop](https://docs.docker.com/get-docker/)** before you begin.
...
To learn more about endpoints, see the [Working with endpoints](https://docs.serverpod.dev/2.4.0/concepts/working-with-endpoints.md) section.
...
You can also create custom serialized classes with tools such as Freezed. Learn more in the [Serialization](https://docs.serverpod.dev/2.4.0/concepts/serialization.md) section.
...
To learn more about database migrations, see the [Migrations](https://docs.serverpod.dev/2.4.0/concepts/database/migrations.md) section.
...
To learn more about database CRUD operations, see the [CRUD](https://docs.serverpod.dev/2.4.0/concepts/database/crud.md) section.
...
Working with a database is an extensive subject. Learn more in the [Database](https://docs.serverpod.dev/2.4.0/concepts/database/connection.md) section.

:::

## Where to go next

You should now have a basic understanding of how Serverpod works. The different topics are described in more detail in the *Concepts* section of the documentation. If you are unfamiliar with server-side development, a good starting place for learning is to do the [Build your first app](https://docs.serverpod.dev/2.4.0/tutorials/first-app.md) tutorial. There are also many good video tutorials linked in the *Tutorials* section.
