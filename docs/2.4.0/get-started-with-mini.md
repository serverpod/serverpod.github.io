...
https://docs.serverpod.dev/2.4.0/get-started-with-mini
...
You are now ready to start exploring the exciting world of Serverpod! And even if you start out with Serverpod mini, you can always [upgrade](https://docs.serverpod.dev/2.4.0/upgrading/upgrade-from-mini.md) to the full version later.
