...
https://docs.serverpod.dev/2.8.0/tutorials/first-app
...
[Watch the video](https://www.youtube-nocookie.com/embed/HW8f8Bn0BB0)

We are assuming you have all the tools setup and ready to go. If not, please follow the [Installing Serverpod](https://docs.serverpod.dev/index.md) guide to get up and running.
...
[Watch the video](https://docs.serverpod.dev/img/tutorial/note-app/01-note-app-demo.mp4)
...
![Serverpod Insights](https://docs.serverpod.dev/img/tutorial/note-app/02-note-class-v2.png)
...
[Watch the video](https://docs.serverpod.dev/img/tutorial/note-app/03-note-create.mp4)
...
[Watch the video](https://docs.serverpod.dev/img/tutorial/note-app/04-note-delete.mp4)
