...
https://docs.serverpod.dev/3.3.0/get-started/models-and-data
...
You can use most primitive Dart types here or any other models you have specified in other YAML files. You can also use typed `List`, `Map`, or `Set`. For detailed information, see [Working with models](https://docs.serverpod.dev/3.3.0/concepts/models.md)
