...
https://docs.serverpod.dev/3.3.0/concepts/authentication/legacy/providers/google
...
:::caution
You need to install the auth module before you continue, see [Setup](https://docs.serverpod.dev/3.3.0/concepts/authentication/legacy/setup.md).
:::
