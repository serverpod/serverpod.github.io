...
https://docs.serverpod.dev/3.3.0/concepts/authentication/providers/github/setup
...
2. Click **New GitHub App** (recommended) or **New OAuth App**.
   ...
   ![GitHub App Setup](https://docs.serverpod.dev/img/authentication/providers/github/1-register-app.png)
...
3. Fill in the required fields:
   ...
   ![GitHub App Setup](https://docs.serverpod.dev/img/authentication/providers/github/2-add-permission.png)

   ![GitHub App Setup](https://docs.serverpod.dev/img/authentication/providers/github/3-add-permission.png)
...
5. After the app is created, click **Generate a new client secret** to obtain the **Client Secret**. Copy both the **Client ID** and **Client Secret** for later use.
   ...
   ![GitHub App Setup](https://docs.serverpod.dev/img/authentication/providers/github/4-get-credentials.png)
...
For more details on configuration options, see the [configuration section](https://docs.serverpod.dev/3.3.0/concepts/authentication/providers/github/configuration.md).
...
For details on how to customize the GitHub Sign-In UI in your Flutter app, see the [customizing the UI section](https://docs.serverpod.dev/3.3.0/concepts/authentication/providers/github/customizing-the-ui.md).
