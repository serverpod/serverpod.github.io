...
https://docs.serverpod.dev/1.1.0/concepts/logging
...
You can use the companion app  **[Serverpod Insights](https://docs.serverpod.dev/1.1.0/insights.md)** to read, search, and configure the logs.
