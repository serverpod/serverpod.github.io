...
https://docs.serverpod.dev/1.1.0/contribute
...
You will need to enable actions to run on your forked repository. Enable *Allow all actions and reusable workflows* in *Settings* > *Actions* > *General*.
