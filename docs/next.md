...
- **Logging and monitoring:** Inspect requests, exceptions, and slow queries with [Serverpod Insights](https://docs.serverpod.dev/next/tools/insights.md), the desktop app that ships with Serverpod.
...
- **Web server:** Serve REST APIs, webhooks, and web pages with the built-in [web server](https://docs.serverpod.dev/next/concepts/web-server/overview.md), based on [Relic](https://docs.dartrelic.dev/).
