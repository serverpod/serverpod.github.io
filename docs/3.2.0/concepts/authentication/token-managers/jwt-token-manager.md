...
https://docs.serverpod.dev/3.2.0/concepts/authentication/token-managers/jwt-token-manager
...
:::warning
The deprecated `client.openStreamingConnection()` interface is not compatible with JWT authentication. If you are using JWT tokens, migrate to [streaming endpoints](https://docs.serverpod.dev/3.2.0/concepts/streams.md) instead.
:::
