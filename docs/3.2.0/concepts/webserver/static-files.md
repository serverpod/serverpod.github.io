...
https://docs.serverpod.dev/3.2.0/concepts/webserver/static-files
...
See [Routing](https://docs.serverpod.dev/3.2.0/concepts/webserver/routing.md#wildcards) for more on wildcards.
...
For dynamic content that changes per request, see [Server-side HTML](https://docs.serverpod.dev/3.2.0/concepts/webserver/server-side-html.md).
