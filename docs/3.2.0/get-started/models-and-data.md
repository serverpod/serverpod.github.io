...
https://docs.serverpod.dev/3.2.0/get-started/models-and-data
...
Models files can be placed anywhere in the server's `lib` directory. We will create a new model file called `recipe.spy.yaml` in the `magic_recipe_server/lib/src/recipes/` directory. Use the `.spy.yaml` extension to indicate that this is a *serverpod YAML* file.
...
You can use most primitive Dart types here or any other models you have specified in other YAML files. You can also use typed `List`, `Map`, or `Set`. For detailed information, see [Working with models](https://docs.serverpod.dev/3.2.0/concepts/models.md)
...
![Flutter Recipe App](https://docs.serverpod.dev/img/getting-started/flutter-web-ingredients.png)
