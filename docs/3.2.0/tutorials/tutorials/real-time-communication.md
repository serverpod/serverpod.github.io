...
https://docs.serverpod.dev/3.2.0/tutorials/tutorials/real-time-communication
...
Before you begin, make sure that you have [installed Serverpod](https://docs.serverpod.dev/index.md). It's also recommended that you read the [Get started with Mini](https://docs.serverpod.dev/3.2.0/serverpod-mini.md) guide.
...
With the release of Serverpod 2.1, a new feature called [streaming methods](https://docs.serverpod.dev/3.2.0/concepts/streams.md) was introduced. This feature allows us to return a stream from a server method and call it from our app. Serverpod handles the underlying web socket connection for us. Now, let's get started with building Pixorama.
