...
https://docs.serverpod.dev/3.0.0/deployments/deploying-to-aws
...
2. In file `mypod_server/deploy/aws/scripts/install_dependencies`, you can specify on top of the page the version of Dart SDK that you are using after `DART_VERSION=`.
