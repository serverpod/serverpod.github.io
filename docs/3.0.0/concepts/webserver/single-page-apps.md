...
https://docs.serverpod.dev/3.0.0/concepts/webserver/single-page-apps
...
For serving Flutter web applications specifically, see [Flutter web apps](https://docs.serverpod.dev/3.0.0/concepts/webserver/flutter-web.md).
