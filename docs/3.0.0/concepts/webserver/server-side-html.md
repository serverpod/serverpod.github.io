...
https://docs.serverpod.dev/3.0.0/concepts/webserver/server-side-html
...
- Use [custom routes](https://docs.serverpod.dev/3.0.0/concepts/webserver/routing.md) for REST APIs and custom request handling
- Serve [static files](https://docs.serverpod.dev/3.0.0/concepts/webserver/static-files.md) for CSS, JavaScript, and images
- Add [middleware](https://docs.serverpod.dev/3.0.0/concepts/webserver/middleware.md) for cross-cutting concerns like logging and
  error handling
