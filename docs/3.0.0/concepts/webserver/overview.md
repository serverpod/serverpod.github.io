...
https://docs.serverpod.dev/3.0.0/concepts/webserver/overview
...
See [Routing](https://docs.serverpod.dev/3.0.0/concepts/webserver/routing.md) for details.
...
See [Static Files](https://docs.serverpod.dev/3.0.0/concepts/webserver/static-files.md) for cache-busting and optimization.
...
- **[Routing](https://docs.serverpod.dev/3.0.0/concepts/webserver/routing.md)** - Match requests to handlers by method and URL pattern
- **[Request Data](https://docs.serverpod.dev/3.0.0/concepts/webserver/request-data.md)** - Access path parameters, query parameters, headers, and body
- **[Middleware](https://docs.serverpod.dev/3.0.0/concepts/webserver/middleware.md)** - Intercept and transform requests and responses
- **[Static Files](https://docs.serverpod.dev/3.0.0/concepts/webserver/static-files.md)** - Serve static assets
- **[Server-side HTML](https://docs.serverpod.dev/3.0.0/concepts/webserver/server-side-html.md)** - Render HTML dynamically on the server
- **[Single Page Apps](https://docs.serverpod.dev/3.0.0/concepts/webserver/single-page-apps.md)** - Serve SPAs with client-side routing
- **[Flutter Web Apps](https://docs.serverpod.dev/3.0.0/concepts/webserver/flutter-web.md)** - Serve Flutter web applications
