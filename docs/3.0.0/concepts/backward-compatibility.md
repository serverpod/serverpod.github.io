...
https://docs.serverpod.dev/3.0.0/concepts/backward-compatibility
...
An [endpoint sub-class](https://docs.serverpod.dev/3.0.0/concepts/working-with-endpoints.md) can be useful when you have to make a breaking change to an entire endpoint but need to keep supporting existing clients. Doing so allows you to share most of its implementation with the old endpoint.
