...
https://docs.serverpod.dev/3.0.0/concepts/authentication/ui-components
...
It is not possible to forcefully enable a provider, since this depends on the configuration of the identity providers, as described in the [setup section](https://docs.serverpod.dev/3.0.0/concepts/authentication/setup.md#identity-providers-configuration).
...
For more details on all options of each provider widget, see the "Customizing UI" section of the specific provider documentation. There you will also find information on how to build a custom UI with the controller. For example, see the [Email Provider](https://docs.serverpod.dev/3.0.0/concepts/authentication/providers/email/customizing-the-ui.md) documentation.
