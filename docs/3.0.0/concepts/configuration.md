...
https://docs.serverpod.dev/3.0.0/concepts/configuration
...
- **Cloud storage**: see [Uploading files](https://docs.serverpod.dev/3.0.0/concepts/file-uploads.md) for Google Cloud Storage, AWS S3, and Cloudflare R2 secrets.
- **Authentication**: see [Storing Secrets](https://docs.serverpod.dev/3.0.0/concepts/authentication/setup.md#storing-secrets) on the Authentication setup page.
...
See the [testing documentation](https://docs.serverpod.dev/3.0.0/concepts/testing/get-started.md) for more details.
...
This allows you to reference module classes as `module:auth:AuthUser` in your model files. See the [modules documentation](https://docs.serverpod.dev/3.0.0/concepts/modules.md) for more information.
...
See the [serialization documentation](https://docs.serverpod.dev/3.0.0/concepts/serialization.md) for implementing custom serializable classes.
...
See the [experimental features documentation](https://docs.serverpod.dev/3.0.0/concepts/experimental.md) for detailed information about each feature.
