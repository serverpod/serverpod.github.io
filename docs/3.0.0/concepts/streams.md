...
https://docs.serverpod.dev/3.0.0/concepts/streams
...
For more details on handling revoked authentication, refer to the section on [handling revoked authentication](https://docs.serverpod.dev/3.0.0/concepts/authentication/custom-overrides.md#handling-revoked-authentication).
...
Read more about serializable exceptions here: [Serializable exceptions](https://docs.serverpod.dev/3.0.0/concepts/exceptions.md).
