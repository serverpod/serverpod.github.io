...
https://docs.serverpod.dev/3.0.0/upgrading/upgrade-to-three
...
- Legacy streaming endpoints → Use [streaming methods](https://docs.serverpod.dev/3.0.0/concepts/streams.md) for new code
