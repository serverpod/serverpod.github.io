...
https://docs.serverpod.dev/tutorials/tutorials/real-time-communication
...
With the release of Serverpod 2.1, a new feature called [streaming methods](https://docs.serverpod.dev/concepts/streams.md) was introduced. This feature allows us to return a stream from a server method and call it from our app. Serverpod handles the underlying web socket connection for us. Now, let's get started with building Pixorama.
