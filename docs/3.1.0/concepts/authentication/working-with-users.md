...
https://docs.serverpod.dev/3.1.0/concepts/authentication/working-with-users
...
:::tip
When referencing module classes in your model files, you can use a nickname for the module instead of the full module name. See the [modules documentation](https://docs.serverpod.dev/3.1.0/concepts/modules.md) for more information.
:::
