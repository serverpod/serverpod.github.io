...
https://docs.serverpod.dev/3.1.0/concepts/authentication/providers/google/configuration
...
- Add the required scopes to the [Data Access](https://docs.serverpod.dev/3.1.0/concepts/authentication/providers/google/setup.md#configure-google-auth-platform) page in the Google Auth Platform.
