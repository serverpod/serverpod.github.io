...
https://docs.serverpod.dev/3.1.0/concepts/experimental
...
To override the column name, use the `column` keyword in the `fields` configuration of your [model](https://docs.serverpod.dev/3.1.0/concepts/database/models.md) file to specify the column name in the database.
...
- **Relations**: The `column` keyword is only allowed on the [foreign key field](https://docs.serverpod.dev/3.1.0/concepts/database/relations/one-to-one.md#with-an-id-field) of a relation.
...
The column name override is also supported when using [inheritance](https://docs.serverpod.dev/3.1.0/concepts/models.md#inheritance) and will be applied to all child classes. This is especially useful when you have multiple database tables that share similar column names. This allows you to define a parent class as a regular [model](https://docs.serverpod.dev/3.1.0/get-started/models-and-data.md) and specify additional fields in the child classes defined as [table models](https://docs.serverpod.dev/3.1.0/concepts/database/models.md).
