...
https://docs.serverpod.dev/3.1.0/concepts/scheduling
...
Future calls can be configured using options defined in the configuration files or environment variables. For a detailed list of configuration options, refer to the [Configuration](https://docs.serverpod.dev/3.1.0/concepts/configuration.md) page.
