...
https://docs.serverpod.dev/3.1.0/get-started/working-with-the-database
...
:::info
Check out the reference for [database models](https://docs.serverpod.dev/3.1.0/concepts/models.md#keywords-1) for an overview of all available keywords.
:::
...
Each time you run `serverpod create-migration`, a new migration file will be created in your *migrations* folder. These step-by-step migrations provide a history of your database changes and allow you to roll back changes if needed.
...
The `insertRow` method is used to insert a new row into the database. The `find` method is used to query the database and get all the rows of a specific type. See [CRUD](https://docs.serverpod.dev/3.1.0/concepts/database/crud.md) and [relation queries](https://docs.serverpod.dev/3.1.0/concepts/database/relation-queries.md) for more information.
:::
...
![Final result](https://docs.serverpod.dev/img/getting-started/final-result.png)
...
:::tip
Database operations are a broad topic, and Serverpod's ORM offers many powerful features. To learn more about advanced database operations, check out the [Database](https://docs.serverpod.dev/3.1.0/concepts/database/connection.md) section.
:::
