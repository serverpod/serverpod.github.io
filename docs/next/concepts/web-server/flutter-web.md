...
https://docs.serverpod.dev/next/concepts/web-server/flutter-web
...
:::info
The route path defaults to `'/'` (root). See [Serving from a sub-path](https://docs.serverpod.dev/next/concepts/web-server/single-page-apps.md#serving-from-a-sub-path) to mount the app at a different location.
:::
...
See [Static files](https://docs.serverpod.dev/next/concepts/web-server/static-files.md#cache-control) for more on cache control.
