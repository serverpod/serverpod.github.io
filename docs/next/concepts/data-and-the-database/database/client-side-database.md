...
https://docs.serverpod.dev/next/concepts/data-and-the-database/database/client-side-database
...
[CRUD](https://docs.serverpod.dev/next/concepts/data-and-the-database/database/crud.md), [filtering](https://docs.serverpod.dev/next/concepts/data-and-the-database/database/filtering.md), [sorting](https://docs.serverpod.dev/next/concepts/data-and-the-database/database/sorting.md), [pagination](https://docs.serverpod.dev/next/concepts/data-and-the-database/database/pagination.md), [relations](https://docs.serverpod.dev/next/concepts/data-and-the-database/database/relations.md), and [transactions](https://docs.serverpod.dev/next/concepts/data-and-the-database/database/transactions.md) all work as they do on the server. Because the database is SQLite, the SQLite-specific behaviors apply:

- `like` and `ilike` are both case-insensitive for ASCII characters. See [filtering](https://docs.serverpod.dev/next/concepts/data-and-the-database/database/filtering.md#ilike).
