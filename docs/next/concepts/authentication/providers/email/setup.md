...
https://docs.serverpod.dev/next/concepts/authentication/providers/email/setup

Sign in with Email verifies the user's address with a code, both when they register and when they reset their password.

:::caution
You need to install the auth module before you continue, see [Setup](https://docs.serverpod.dev/next/concepts/authentication/setup.md).
:::
...
If a code cannot be sent, the failure is recorded in the session log and the sign-in flow continues unchanged, so check your [server logs](https://docs.serverpod.dev/next/concepts/operations/logging.md) when a user reports a missing code.
...
For more details on configuration options, such as customizing password requirements, verification code generation, rate limiting, and more, see the [configuration section](https://docs.serverpod.dev/next/concepts/authentication/providers/email/configuration.md).

## Client-side configuration

If you have configured the `SignInWidget` as described in the [setup section](https://docs.serverpod.dev/next/concepts/authentication/setup.md#present-the-authentication-ui), the Email identity provider will be automatically detected and displayed in the sign-in widget.
...
For details on how to display the email authentication UI in your Flutter app, see the [customizing the UI section](https://docs.serverpod.dev/next/concepts/authentication/providers/email/customizing-the-ui.md).
