...
https://docs.serverpod.dev/next/concepts/endpoints-and-apis/caching
...
- [Sessions](https://docs.serverpod.dev/next/concepts/endpoints-and-apis/sessions.md): the object the caches hang off.
- [Server events](https://docs.serverpod.dev/next/concepts/endpoints-and-apis/server-events.md): the other Redis-backed feature, for messaging between instances.
- [Configuration](https://docs.serverpod.dev/next/concepts/server-fundamentals/configuration.md): where the `redis` section lives.
