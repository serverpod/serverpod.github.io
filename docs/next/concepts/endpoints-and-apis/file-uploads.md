...
2. Under *Cloud Storage* > *Settings* > *Interoperability*, create a new HMAC key for your newly created service account.
...
4. When creating a new bucket, set the *Access control* to *Fine-grained* and disable the *Prevent public access* option.
...
Add your R2 API credentials to the `passwords.yaml` file. You can create access keys from the Cloudflare dashboard under *R2* > *Manage R2 API Tokens*.
