...
https://docs.serverpod.dev/next/concepts/testing/configuration
...
| `databaseInterceptor`      | A [database interceptor](https://docs.serverpod.dev/next/concepts/data-and-the-database/database/database-interceptors.md) for the test server to use.               | `null`                                 |
| `enableSessionLogging`     | Whether session logging is on.                                                                                                                                       | `false`                                |
| `experimentalFeatures`     | Experimental features to enable, such as [diagnostic event handlers](https://docs.serverpod.dev/next/concepts/operations/exception-monitoring.md).                   | `null`                                 |
...
| `runtimeParametersBuilder` | Runtime parameters to apply before startup. See [runtime parameters](https://docs.serverpod.dev/next/concepts/data-and-the-database/database/runtime-parameters.md). | `null`                                 |
...
Test groups created by `withServerpod` are tagged `integration`, which is what lets you run integration and unit tests separately. Change the tag with `testGroupTagsOverride`. See [running tests separately](https://docs.serverpod.dev/next/concepts/testing/advanced-examples.md#run-unit-and-integration-tests-separately).

## Related

- [Writing tests](https://docs.serverpod.dev/next/concepts/testing/writing-tests.md): the pieces every test uses.
- [Advanced examples](https://docs.serverpod.dev/next/concepts/testing/advanced-examples.md): the options above put to work.
- [Server configuration](https://docs.serverpod.dev/next/concepts/server-fundamentals/configuration.md): the config files the test server reads.
