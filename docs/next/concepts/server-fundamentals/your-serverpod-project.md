...
The scaffolded development config also reserves port 8090 for the database and 8091 for [Redis](https://docs.serverpod.dev/next/concepts/server-fundamentals/redis.md).
...
Each editor you pick at create time gets its own MCP config, which registers Serverpod's [MCP server](https://docs.serverpod.dev/next/concepts/cli/commands/mcp-server.md), and a skills folder:
