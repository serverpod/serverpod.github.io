...
https://docs.serverpod.dev/next/concepts/operations/logging
...
- **Stream messages** are the messages passed by [streaming](https://docs.serverpod.dev/next/concepts/endpoints-and-apis/streaming.md) sessions.

## Write your own messages

Call `log` on the [session](https://docs.serverpod.dev/next/concepts/endpoints-and-apis/sessions.md) you were given:
...
:::info
The companion app [Serverpod Insights](https://docs.serverpod.dev/next/tools/insights.md) reads and searches these tables, and can change the runtime settings described below.
:::
...
Durations use the same format as [model default values](https://docs.serverpod.dev/next/concepts/data-and-the-database/models.md#supported-default-values), such as `30d`, `6h`, or `1d 2h 30min`.
...
- [Configuration](https://docs.serverpod.dev/next/concepts/server-fundamentals/configuration.md): the config files these settings live in.
