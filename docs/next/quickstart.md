...
Start the server and the Flutter app by opening up a terminal window and running the [`serverpod start`](https://docs.serverpod.dev/next/concepts/server-fundamentals/running-your-server.md) command:
