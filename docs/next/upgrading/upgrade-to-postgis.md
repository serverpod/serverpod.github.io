...
https://docs.serverpod.dev/next/upgrading/upgrade-to-postgis
...
1. Update your `docker-compose.yml` to use `ghcr.io/serverpod/postgres:16`, the Serverpod PostgreSQL image. It ships with [PostGIS and pgvector](https://docs.serverpod.dev/next/concepts/data-and-the-database/database/vector-and-geography-fields.md) already installed:
...
For more details on creating and applying migrations, see the [Migrations](https://docs.serverpod.dev/next/concepts/data-and-the-database/database/migrations.md) section.
