...
https://docs.serverpod.dev/next/upgrading/migrate-from-legacy-auth
...
- A Serverpod 4.0.x project. If you are on an earlier version, follow [Upgrade to 4.0](https://docs.serverpod.dev/next/upgrading/upgrade-to-four.md) first.
...
See [Storing secrets](https://docs.serverpod.dev/next/concepts/authentication/setup.md#storing-secrets) for production handling and additional provider-specific secrets. For the `googleClientSecret` format, see [Store your credentials](https://docs.serverpod.dev/next/concepts/authentication/providers/google/setup.md#store-your-credentials).
...
4. Create a migration. It drops the legacy, bridge, and migration tables, so `serverpod create-migration` aborts with a warning until you pass `--force`. See [Force create migration](https://docs.serverpod.dev/next/concepts/data-and-the-database/database/migrations.md#force-create-migration).
...
Reach out on the [community page](https://docs.serverpod.dev/next/support.md).

## Related

- [Upgrade to 4.0](https://docs.serverpod.dev/next/upgrading/upgrade-to-four.md): do this first.
- [Authentication setup](https://docs.serverpod.dev/next/concepts/authentication/setup.md): modular configuration reference.
- [Database migrations](https://docs.serverpod.dev/next/concepts/data-and-the-database/database/migrations.md): creating and applying schema changes safely.
