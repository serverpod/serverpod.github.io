...
https://docs.serverpod.dev/1.2.0
...
Download the latest version here: **[Serverpod Insights](https://docs.serverpod.dev/tools/insights.md)**. It is compatible with Serverpod version 1.2.x. Always use the same version of Serverpod Insights as for the framework itself.
