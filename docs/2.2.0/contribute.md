...
https://docs.serverpod.dev/2.2.0/contribute
...
[Watch the video](https://www.youtube-nocookie.com/embed/V3CqPx4jykE)
...
- **`serverpod_client`**: The client classes that are not generated by the CLI tooling.
