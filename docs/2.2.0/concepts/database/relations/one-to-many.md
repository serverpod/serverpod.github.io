...
https://docs.serverpod.dev/2.2.0/concepts/database/relations/one-to-many
...
When fetching companies it now becomes possible to include any or all employees in the query. 1:n relations also enables additional [filtering](https://docs.serverpod.dev/2.2.0/concepts/database/filter.md#one-to-many) and [sorting](https://docs.serverpod.dev/2.2.0/concepts/database/sort.md#sort-on-relations) operations for [relational queries](https://docs.serverpod.dev/2.2.0/concepts/database/relation-queries.md).

### Explicit definition

In an explicit definition, you directly specify the relationship in a one-to-many relation.

This can be done by through an [object relation](https://docs.serverpod.dev/2.2.0/concepts/database/relations/one-to-one.md#with-an-object):
...
Or through a [foreign key field](https://docs.serverpod.dev/2.2.0/concepts/database/relations/one-to-one.md#with-an-id-field):
...
Either through an [object relation](https://docs.serverpod.dev/2.2.0/concepts/database/relations/one-to-one.md#with-an-object) on the many side:
...
Or through a [foreign key field](https://docs.serverpod.dev/2.2.0/concepts/database/relations/one-to-one.md#with-an-id-field) on the many side:
