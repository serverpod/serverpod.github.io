...
https://docs.serverpod.dev/2.2.0/concepts/authentication/basics
...
For more detailed information on managing and revoking authentication keys, please refer to the [Revoking authentication keys](https://docs.serverpod.dev/2.2.0/concepts/authentication/providers/custom-providers.md#revoking-authentication-keys) section.
...
The behavior of `signOut` is controlled by `legacyUserSignOutBehavior`, which you can adjust in the [configure authentication](https://docs.serverpod.dev/2.2.0/concepts/authentication/setup.md#configure-authentication) section. This allows you to control the signout behaviour of already shipped clients.
:::
