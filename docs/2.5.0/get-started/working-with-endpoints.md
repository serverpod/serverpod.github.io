...
https://docs.serverpod.dev/2.5.0/get-started/working-with-endpoints
...
To learn more about endpoints, see the [Working with endpoints](https://docs.serverpod.dev/2.5.0/concepts/working-with-endpoints.md) section.
