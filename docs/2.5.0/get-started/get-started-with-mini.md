...
https://docs.serverpod.dev/2.5.0/get-started/get-started-with-mini

Serverpod Mini is a slimmer version of Serverpod that does not need to be connected to a Postgres database. Before you begin, make sure that you have **[Flutter](https://flutter.dev/docs/get-started/install)** and **[Serverpod](https://docs.serverpod.dev/index.md)** installed.

[Watch the video](https://www.youtube-nocookie.com/embed/dSBK4JOZRyI)
...
You are now ready to start exploring the exciting world of Serverpod! And even if you start out with Serverpod mini, you can always [upgrade](https://docs.serverpod.dev/2.5.0/upgrading/upgrade-from-mini.md) to the full version later.
