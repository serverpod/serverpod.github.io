...
https://docs.serverpod.dev/2.5.0/concepts/testing/advanced-examples
...
To change the name of this tag, see the [`testGroupTagsOverride`](https://docs.serverpod.dev/2.5.0/concepts/testing/the-basics.md#configuration) configuration option.
