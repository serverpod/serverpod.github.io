...
https://docs.serverpod.dev/upgrading/upgrade-to-pgvector
...
For more details on creating and applying migrations, see the [Migrations](https://docs.serverpod.dev/concepts/database/migrations.md) section.
