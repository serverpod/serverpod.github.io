...
https://docs.serverpod.dev/3.4.0/get-started/deployment
...
- **8081**: The port for connecting with the [Serverpod Insights](https://docs.serverpod.dev/3.4.0/tools/insights.md) tooling. You may want to restrict which IP addresses can connect to this port.
...
Check out [choosing a deployment strategy](https://docs.serverpod.dev/3.4.0/deployments/deployment-strategy.md) for more information on how to deploy your Serverpod application to other platforms.
