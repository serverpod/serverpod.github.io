...
https://docs.serverpod.dev/3.4.0/concepts/authentication/ui-components
...
It is not possible to forcefully enable a provider, since this depends on the configuration of the identity providers, as described in the [setup section](https://docs.serverpod.dev/3.4.0/concepts/authentication/setup.md#identity-providers-configuration).
