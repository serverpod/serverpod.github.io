...
https://docs.serverpod.dev/3.4.0/concepts/authentication/token-managers/server-side-sessions-token-manager
...
See [Issuing Tokens](https://docs.serverpod.dev/3.4.0/concepts/authentication/token-managers/managing-tokens.md#issuing-tokens) in Managing tokens for more context.
