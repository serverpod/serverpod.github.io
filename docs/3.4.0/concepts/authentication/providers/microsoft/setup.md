...
https://docs.serverpod.dev/3.4.0/concepts/authentication/providers/microsoft/setup
...
For more details on configuration options, see the [configuration section](https://docs.serverpod.dev/3.4.0/concepts/authentication/providers/microsoft/configuration.md).
...
:::info
For more information on configuration options and environment variables, see the [configuration section](https://docs.serverpod.dev/3.4.0/concepts/authentication/providers/microsoft/configuration.md).
:::

### Using the `MicrosoftSignInWidget`

If you have configured the `SignInWidget` as described in the [setup section](https://docs.serverpod.dev/3.4.0/concepts/authentication/setup.md#present-the-authentication-ui), the Microsoft identity provider will be automatically detected and displayed in the sign-in widget.
...
For details on how to customize the Microsoft Sign-In UI in your Flutter app, see the [customizing the UI section](https://docs.serverpod.dev/3.4.0/concepts/authentication/providers/microsoft/customizing-the-ui.md).
