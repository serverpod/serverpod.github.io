...
https://docs.serverpod.dev/3.4.0/concepts/authentication/providers/apple/setup
...
:::caution
You need to install the auth module before you continue, see [Setup](https://docs.serverpod.dev/3.4.0/concepts/authentication/setup.md).
:::
...
For more details on configuration options, see the [configuration section](https://docs.serverpod.dev/3.4.0/concepts/authentication/providers/apple/configuration.md).

## Client-side configuration

The `serverpod_auth_idp_flutter` package implements the sign-in logic using [sign\_in\_with\_apple](https://pub.dev/packages/sign_in_with_apple). The documentation for this package should in most cases also apply to the Serverpod integration.
...
If you have configured the `SignInWidget` as described in the [setup section](https://docs.serverpod.dev/3.4.0/concepts/authentication/setup.md#present-the-authentication-ui), the Apple identity provider will be automatically detected and displayed in the sign-in widget.
...
![Apple sign-in button](https://docs.serverpod.dev/img/authentication/providers/apple/3-button.png)
...
For details on how to customize the Apple Sign-In UI in your Flutter app, see the [customizing the UI section](https://docs.serverpod.dev/3.4.0/concepts/authentication/providers/apple/customizing-the-ui.md).
...
If you run into issues, see the [troubleshooting guide](https://docs.serverpod.dev/3.4.0/concepts/authentication/providers/apple/troubleshooting.md).
