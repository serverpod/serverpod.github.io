...
https://docs.serverpod.dev/3.4.0/concepts/authentication/providers/apple/troubleshooting
...
Alternatively, set `appleKey` as an environment variable to avoid YAML indentation entirely. See [Environment Variable equivalents](https://docs.serverpod.dev/3.4.0/concepts/authentication/providers/apple/configuration.md#environment-variable-equivalents) in the configuration page.
