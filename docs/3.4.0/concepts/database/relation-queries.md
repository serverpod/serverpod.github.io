...
https://docs.serverpod.dev/3.4.0/concepts/database/relation-queries

The Serverpod query framework supports filtering on, sorting on, and including relational data structures. In SQL this is often achieved using a join operation. The functionality is available if there exists any [one-to-one](https://docs.serverpod.dev/3.4.0/concepts/database/relations/one-to-one.md) or [one-to-many](https://docs.serverpod.dev/3.4.0/concepts/database/relations/one-to-many.md) object relations between two models.
...
When working with large datasets, it's often necessary to [filter](https://docs.serverpod.dev/3.4.0/concepts/database/filter.md) and [sort](https://docs.serverpod.dev/3.4.0/concepts/database/sort.md) the records to retrieve the most relevant data. Serverpod offers methods to refine the included list of related objects:
...
[Paginate](https://docs.serverpod.dev/3.4.0/concepts/database/pagination.md) results by specifying a limit on the number of records and an offset.
