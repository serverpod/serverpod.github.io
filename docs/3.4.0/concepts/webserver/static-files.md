...
https://docs.serverpod.dev/3.4.0/concepts/webserver/static-files
...
For dynamic content that changes per request, see [Server-side HTML](https://docs.serverpod.dev/3.4.0/concepts/webserver/server-side-html.md).
