...
https://docs.serverpod.dev/2.6.0/concepts/server-events
...
The messaging interface also exposes a method for revoking authentication. For more details on handling revoked authentication, refer to the section on [handling revoked authentication](https://docs.serverpod.dev/2.6.0/concepts/authentication/custom-overrides.md#handling-revoked-authentication).
