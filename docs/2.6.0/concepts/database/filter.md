...
https://docs.serverpod.dev/2.6.0/concepts/database/filter
...
If a relation between two models is defined a [one-to-one](https://docs.serverpod.dev/2.6.0/concepts/database/relations/one-to-one.md) or [one-to-many](https://docs.serverpod.dev/2.6.0/concepts/database/relations/one-to-many.md) object relation, then relation operations are supported in Serverpod.
